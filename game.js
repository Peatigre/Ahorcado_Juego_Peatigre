...
console.log("Respuestas en minusculas = " + answer);
if(answer == word)
{
	...
	if(question_turn == "player_1")
	{
		...
		document.getElementById("player_question").inetHTML = "Turno para preguntar = " + player2_name;
	}
	else
	{
		question_turn = "player1"
		document.getElementById("player_question").innetHTML = ("turno para preguntar = " + player1_name);
	}
	if(answer_turn == "player1")
	{
		answer_turn = "player2"
		document.getElementById("player_answer").innetHTML = ("turno para responder = " + player2_name);
	}
	else
	{
		question_turn = "player1"
		document.getElementById("player_answer").innetHTML = ("turno para responder = " + player1_name);
	}
}
